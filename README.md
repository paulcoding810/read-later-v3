...
![GitHub action badge](https://github.com/paulcoding810/read-later/actions/workflows/build-zip.yml/badge.svg)
![GitHub action badge](https://github.com/paulcoding810/read-later/actions/workflows/lint.yml/badge.svg)

<img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https://github.com/paulcoding810/read-laterFactions&count_bg=%23#222222&title_bg=%23#454545&title=😀&edge_flat=true" alt="hits"/>
<a href="https://discord.gg/4ERQ6jgV9a" target="_blank"><img src="https://discord.com/api/guilds/1263404974830915637/widget.png"/></a>

> This boilerplate
> has [Legacy version](https://github.com/paulcoding810/read-later/tree/legacy)
...
1. Clone this repository: `git clone https://github.com/paulcoding810/read-later`
...
1. Run:
    - Dev: `pnpm dev` (on Windows, you should run as administrator; see [issue#456](https://github.com/paulcoding810/read-later/issues/456))
    - Prod: `pnpm build`
...
2. If you get a [`grpc` error](https://github.com/paulcoding810/read-later/issues/612),
   [kill the `turbo` process](https://github.com/paulcoding810/read-later/issues/612#issuecomment-2518982339) and run `pnpm dev` again.
...
<a href="https://star-history.com/#Jonghakseo/read-later&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Jonghakseo/read-later&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Jonghakseo/read-later&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Jonghakseo/read-later&type=Date" />
 </picture>
</a>
...
<a href="https://github.com/paulcoding810/read-later/graphs/contributors">
  <img width="500px" src="https://contrib.rocks/image?repo=Jonghakseo/read-later" alt="All Contributors"/>
</a>
